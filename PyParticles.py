...
class Particle:
    ...
    def __init__(self, tup, size, mass=1):
        self.x = tup[0]
        self.y = tup[1]
        self.size = size
        self.colour = (0, 0, 255)
...
class Environment:
    ...
    def addParticles(self, n=1, **kargs):
        ...
        for i in range(n):
            ...
            particle.x = kargs.get('x')
            particle.y = kargs.get('y')
